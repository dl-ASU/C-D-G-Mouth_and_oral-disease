...
def train(train_loader, test_loader, num_epochs, *args, **kwargs):
    ...
    optimizer1 = optim.Adam(model1.parameters(), lr=args.learning_rate , weight_decay=args.l2)
    optimizer2 = optim.Adam(model2.parameters(), lr=args.learning_rate , weight_decay=args.l2)
    optimizer3 = optim.Adam(model3.parameters(), lr=args.learning_rate , weight_decay=args.l2)
    optimizer4 = optim.Adam(model4.parameters(), lr=args.learning_rate , weight_decay=args.l2)
    ...
    for epoch in range(num_epochs):
        ...
        if epoch%5==0 and epoch!=0:
            torch.save(model.state_dict(), f"model_{base}_epoch_{epoch}.pth")
